  ...
  while (!::glfwWindowShouldClose(window)) {
    if( time < 200.0 ) {
      for (int itr = 0; itr < 100; ++itr) { // sub-stepping
        ...
        // the code below is generated by ChatGPT4
        // Solve Euler's equation for \dot{omega}
        Eigen::Vector3f dot_Omega = -inertia.inverse() * Omega.cross(inertia*Omega); 
        ...
        skew_omega << 0.0f, -Omega(2), Omega(1),
                      Omega(2), 0.0f, -Omega(0),
                      -Omega(1), Omega(0), 0.0f;
        Eigen::Matrix3f dot_rotation = rotation * skew_omega; 

        // Update rotation
        rotation += dot_rotation * dt;
      }
